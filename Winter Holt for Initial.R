...
#--To Do:-----------------------------------------------------------------------
#Winter Holt Model -- this may be breaking down since the data is on an hourly 
# level; Try using this link: https://community.rstudio.com/t/convert-hourly-data-to-time-series/8380/5
# with the zoo library
#Compare with Values
#modify Date Ranges to accommodate previous forecasts
#Modify for other forecasts
#Add Lambda for EDD and FFIF
#-------------------------------------------------------------------------------
...
#########################Need to modify this to use IIC data ###################
# this library had trouble loading
